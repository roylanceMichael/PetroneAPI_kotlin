package kr.co.byrobot.petroneapi.Wifi.channels.Impl

import kr.co.byrobot.petroneapi.Wifi.channels.*
import java.nio.CharBuffer


internal class BufferedCharReadChannelImpl(val source: CharReadChannel,
    private var buffer: CharBuffer) : BufferedCharReadChannel {
 ...
 */
fun CharReadChannel.buffered(size: Int = 8192,
    bufferSupplier: (Int) -> CharBuffer = CharBuffer::allocate): BufferedCharReadChannel = BufferedCharReadChannelImpl(
    this, bufferSupplier(size).apply { position(limit()) })